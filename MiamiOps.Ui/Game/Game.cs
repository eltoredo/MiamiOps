...
namespace MiamiOps
{
    public class Game : GameLoop
    {
        ...
        public override void Initialize()
        {
            ...
            _round = _gameHandlerCtx.RoundObject; // new Round(_gameHandlerCtx, 10, enemieSpawn: new Vector(), enemiesSpeed: 0.0005f, playerSpeed: 0.005f,enemySpawn: _convert.ConvertXMLSpawn(@"..\..\..\..\MiamiOps.Map\Map\tilemap.tmx"),playerHauteur:0f,playerLargeur:0f, playerLife: 100);
