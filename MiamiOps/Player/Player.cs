...
namespace MiamiOps
{
    public class Player
    {
        ...
        public Player(int levelTexture, int nbSprite, int spriteWidth, int spriteHeight, float life, float speed)
        {
            _playerTexture = new Texture("../../../resources/sprite_panda_lv" + levelTexture.ToString() + ".png");
        ...
        {
            _direction = _spriteHeight * (int) direction;
